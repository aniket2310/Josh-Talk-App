...
public class LibrariesForLibsInPluginsBlock extends AbstractExternalDependencyFactory {
    ...
    public static class ComposeLibraryAccessors extends SubDependencyFactory {
         ...
         * with version reference <b>compose.android.ui</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         *
         * @deprecated Will be removed in Gradle 9.0.
         ...
         * with version reference <b>compose.android.material3</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         *
         * @deprecated Will be removed in Gradle 9.0.
    ...
    public static class ComposeVersionAccessors extends VersionFactory  {
        ...
        private final ComposeAndroidVersionAccessors vaccForComposeAndroidVersionAccessors = new ComposeAndroidVersionAccessors(providers, config);
        ...
        /**
         * Group of versions at <b>versions.compose.android</b>
         */
        public ComposeAndroidVersionAccessors getAndroid() {
            return vaccForComposeAndroidVersionAccessors;
        }

    }

    public static class ComposeAndroidVersionAccessors extends VersionFactory  {

        public ComposeAndroidVersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }

        /**
         * Version alias <b>compose.android.material3</b> with value <b>1.3.1</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getMaterial3() { return getVersion("compose.android.material3"); }

        /**
         * Version alias <b>compose.android.ui</b> with value <b>1.7.5</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getUi() { return getVersion("compose.android.ui"); }
    ...
    public static class NavigationVersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>navigation.compose</b> with value <b>2.8.0-alpha08</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
